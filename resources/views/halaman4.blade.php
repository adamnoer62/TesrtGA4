...
<body>
    <script>
        gtag("event", "tokopedia_link_clicks");
    </script>
        ...
        <div class="content">
            <div class="title m-b-md">
                ...
                <a class="btn btn-primary"
                    href="https://www.searchenginejournal.com/google-analytics-event-tracking/484607/#close"
                    id="test">halaman
                    disini</a>
            </div>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TXSH9Q66" height="0" width="0"
